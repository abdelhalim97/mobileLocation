...
public class PositionAdapter extends BaseAdapter {
    //role d'adapter creation des views pr chaque data
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        PositionContact pc=data.get(position);//les chapms lezemni n3abeho m data
        ...
        fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                File f=new File(Environment.getExternalStorageDirectory().getPath(),"favoris.csv");//declarina chemin
                try {
                    FileWriter writer=new FileWriter(f,true);//mode append =concatination m3a continue kdim
            ...
            public void onClick(View view) {
                if(MainActivity.gps_permission) {
                    Intent i = new Intent(Intent.ACTION_VIEW,
                            Uri.parse("geo" + pc.longitude + "," + pc.latitude));//geo:position gps
                    con.startActivity(i);
                }
            }
        });
        ...
        sup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                notifyDataSetChanged();//raffraichir de l'affichage'
            }
        });
